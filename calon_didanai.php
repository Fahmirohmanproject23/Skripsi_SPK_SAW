...
?>
<?php
$page = 'calon_didanai'; include './template/sidebar.php';
?>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<div class="card-header">
									<h4 class="card-title">Data Calon Didanai</h4>
								</div>
								<div class="card">
								<div class="card-body">
...
?>
											...
											include 'aksilogin/config.php';
												...
												$data = mysqli_query($koneksi, "SELECT * FROM tb_siswa where status_bantuan='Didanai'");
												$nomor = 1;
