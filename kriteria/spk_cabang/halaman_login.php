...
<body>
	...
	<h4><center><br> Selamat Datang di Sistem Pendukung Keputusan </center></h4>
  <h4><center>Pemilihan Calon Penerima Bantuan PIP di SD Negeri Kalisalak 03</center></h4>
	<img class="wave" src="assets/logins/img/wave.png">
	<div class="container">
		<div class="img">
			<img src="assets/logins/img/bg.svg">
		</div>
		<div class="login-content">
			<form action="login.php" method="post">
				<img src="assets/logins/img/avatar.svg">
